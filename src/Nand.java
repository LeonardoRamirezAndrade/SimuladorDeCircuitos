...
public class Nand extends Compuertas {
    ...
    public void draw(Graphics2D g) {
        ...
        g.drawOval(x + 50, y + 20, 10, 10); // Circulo
        g.drawLine(x - 20, y + 15, x, y + 15); // Patita Arriba
        g.drawLine(x - 20, y + 35, x, y + 35); // Patita abajo
        g.drawLine(x + 60, y + 25, x + 70, y + 25); // Linea que resalta afuera 
